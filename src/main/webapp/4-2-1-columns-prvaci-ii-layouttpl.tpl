<div class="columns-4-2-1 columns-layout-30-70" id="main-content" role="main">
		...
		<tr>
			...
			<td class="aui-w25 portlet-column" id="column-2">
				$processor.processColumn("column-2", "portlet-column-content")
			</td>
			<td class="aui-w25 portlet-column" id="column-3">
		...
		<tr>
			...
			<td class="aui-w70 portlet-column portlet-column-last" id="column-6">
		...
		<div class="portlet-layout">
			...
			<div class="aui-w70 portlet-column portlet-column-last" id="column-6">
				$processor.processColumn("column-6", "portlet-column-content portlet-column-content-last")
			</div>
		</div>
